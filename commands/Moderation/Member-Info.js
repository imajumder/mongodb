...
module.exports = {
    ...
    callback: async (message, arguments) => {
        ...
        const member = message.mentions.members.first() || message.guild.members.cache.get(arguments[0]) || message.member;
        ...
        const embed = new Discord.MessageEmbed()
            .setColor('#2F3136')
            .setAuthor(`${member.user.tag} | Status ~ ${status[member.user.presence.status]}`, member.user.displayAvatarURL())
            .setColor('#2F3136')
