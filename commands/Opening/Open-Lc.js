...
const commonchest = require('../../Util/Legendary-Chest')
...
module.exports = {
  commands: ['open-legendarychest', 'open-lc'],
  ...
  callback: async (message, arguments) => {
    ...
    const chestowned = await commonchest.getLegendaryChest(userId)
    ...
    if(random === 1){
      ...
      const commonchests = await commonchest.addLegendaryChest(
        userId,
        chestsToGive * -1,
      )


        const random1 = Math.floor((Math.random() * 110) + 80) * chestsToGive
        const random2 = Math.floor((Math.random() * 110) + 80) * chestsToGive
        const new1 = await Emerald.addEmeraldsChest(userId, random1)  
        const new2 = await Ruby.addRubyChest(userId, random2) 

        const embed = new Discord.MessageEmbed
        embed.setTitle(`${chestsToGive} Legendary Chests Successfully Opened`)
    ...
    if(random === 2) {
      ...
      const random1 = Math.floor((Math.random() * 110) + 80)* chestsToGive
      const random2 = Math.floor((Math.random() * 110) + 80)* chestsToGive
      const random3 = Math.floor((Math.random() * 110) + 80)* chestsToGive
      const random4 = Math.floor((Math.random() * 90) + 70)* chestsToGive
    ...
    if(random === 3) {
      ...
      const random1 = Math.floor((Math.random() * 110) + 80)* chestsToGive
      const random2 = Math.floor((Math.random() * 110) + 80)* chestsToGive
      const random3 = Math.floor((Math.random() * 80) + 60)* chestsToGive
      const new1 = await Emerald.addEmeraldsChest(userId, random1)
    ...
    if(random === 4) {
      ...
      const random1 = Math.floor((Math.random() * 130) + 90)* chestsToGive
      const random2 = Math.floor((Math.random() * 150) + 130)* chestsToGive
    ...
    if(random === 5){
      ...
      const random1 = Math.floor((Math.random() * 110) + 90)* chestsToGive
      const random2 = Math.floor((Math.random() * 110) + 90)* chestsToGive
      const random3 = Math.floor((Math.random() * 115) + 85)* chestsToGive
