...
module.exports = {
  commands: ['open-commonchest', 'open-cc'],
  ...
  callback: async (message, arguments) => {
    ...
    const chestowned = await commonchest.getCommonChest(userId)
    ...
    if(random === 1){
      ...
      const commonchests = await commonchest.addCommonChest(
        userId,
        chestsToGive * -1,
      )


        const random1 = Math.floor((Math.random() * 15) + 1) * chestsToGive
        const random2 = Math.floor((Math.random() * 10) + 1) * chestsToGive
        const new1 = await Emerald.addEmeraldsChest(userId, random1)  
        const new2 = await Ruby.addRubyChest(userId, random2) 

        const embed = new Discord.MessageEmbed
        embed.setTitle(`${chestsToGive} Common Chests Successfully Opened`)
    ...
    if(random === 2) {
      ...
      const random1 = Math.floor((Math.random() * 10) + 1)* chestsToGive
      const random2 = Math.floor((Math.random() * 7) + 1)* chestsToGive
      const random3 = Math.floor((Math.random() * 5) + 1)* chestsToGive
      const random4 = Math.floor((Math.random() * 2) + 0)* chestsToGive
    ...
    if(random === 3) {
      ...
      const random1 = Math.floor((Math.random() * 10) + 1)* chestsToGive
      const random2 = Math.floor((Math.random() * 7) + 1)* chestsToGive
      const random3 = Math.floor((Math.random() * 3) + 1)* chestsToGive
      const new1 = await Emerald.addEmeraldsChest(userId, random1)
    ...
    if(random === 4) {
      ...
      const random1 = Math.floor((Math.random() * 20) + 1)* chestsToGive
      const random2 = Math.floor((Math.random() * 13) + 1)* chestsToGive
    ...
    if(random === 5){
      ...
      const random1 = Math.floor((Math.random() * 7) + 1)* chestsToGive
      const random2 = Math.floor((Math.random() * 13) + 1)* chestsToGive
      const random3 = Math.floor((Math.random() * 10) + 1)* chestsToGive
