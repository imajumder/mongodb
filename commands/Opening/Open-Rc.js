...
const commonchest = require('../../Util/Rare-Chest')
...
module.exports = {
  commands: ['open-rarechest', 'open-rc'],
  ...
  callback: async (message, arguments) => {
    ...
    const chestowned = await commonchest.getRareChest(userId)
    ...
    if(random === 1){
      ...
      const commonchests = await commonchest.addRareChest(
        userId,
        chestsToGive * -1,
      )


        const random1 = Math.floor((Math.random() * 40) + 20) * chestsToGive
        const random2 = Math.floor((Math.random() * 50) + 30) * chestsToGive
        const new1 = await Emerald.addEmeraldsChest(userId, random1)  
        const new2 = await Ruby.addRubyChest(userId, random2) 

        const embed = new Discord.MessageEmbed
        embed.setTitle(`${chestsToGive} Rare Chests Successfully Opened`)
    ...
    if(random === 2) {
      ...
      const random1 = Math.floor((Math.random() * 40) + 20)* chestsToGive
      const random2 = Math.floor((Math.random() * 40) + 20)* chestsToGive
      const random3 = Math.floor((Math.random() * 40) + 20)* chestsToGive
      const random4 = Math.floor((Math.random() * 20) + 10)* chestsToGive
    ...
    if(random === 3) {
      ...
      const random1 = Math.floor((Math.random() * 40) + 20)* chestsToGive
      const random2 = Math.floor((Math.random() * 40) + 20)* chestsToGive
      const random3 = Math.floor((Math.random() * 20) + 10)* chestsToGive
      const new1 = await Emerald.addEmeraldsChest(userId, random1)
    ...
    if(random === 4) {
      ...
      const random1 = Math.floor((Math.random() * 50) + 35)* chestsToGive
      const random2 = Math.floor((Math.random() * 40) + 20)* chestsToGive
    ...
    if(random === 5){
      ...
      const random1 = Math.floor((Math.random() * 30) + 10)* chestsToGive
      const random2 = Math.floor((Math.random() * 30) + 10)* chestsToGive
      const random3 = Math.floor((Math.random() * 35) + 15)* chestsToGive
