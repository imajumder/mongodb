...
module.exports = {
    ...
    .setColor('#0E1111')
	.setTitle('Support For Rigurr')
	.setAuthor('Rigurr.gg Commands Support', 'https://images.designtrends.com/wp-content/uploads/2016/02/24095354/Cool-Shipping-Company-Isometric-Logo.jpg')
    .setDescription('All the commands supported by Rigurr.gg. Type \'?help [command\' to get more info about the command')
    ...
    .setTimestamp()
    .setFooter('Generated by Rigurr.gg')
