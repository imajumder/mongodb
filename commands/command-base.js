...
embedpermission.setTitle('❌ Permission Error')
embedpermission.setColor('#060103')
embedpermission.setDescription(`You do not have the required permissions to run this command`)
embedpermission.setFooter(`Error Generated By Rigurd`)
embedpermission.setTimestamp()

module.exports = (client, commandOptions) => {
  let {
    commands,
    expectedArgs = '',
    permissionError = embedpermission,
    minArgs = 0,
    maxArgs = null,
    cooldown = -1,
    requiredChannel = '',
